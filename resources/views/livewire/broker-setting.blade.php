<form wire:submit.prevent="save" class="space-y-2">
        ...
        <mijnui:card.content>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="flex items-center gap-2">
                    <mijnui:toggle wire:model="broker_clean_session" />
    ...
    <mijnui:card>
        ...
        <mijnui:card.content class="space-y-4">
            ...
            <div class="flex items-center gap-2">
                <mijnui:toggle wire:model="broker_can_publish" />
                <mijnui:label>Enable Publishing</mijnui:label>
            </div>

            <div class="flex items-center gap-2">
                <mijnui:toggle wire:model="enable_log" />
    ...
    <mijnui:card>
        ...
        <mijnui:card.content class="space-y-4">
            ...
            <div class="flex items-center gap-2">
                <mijnui:toggle wire:model="subscribe_retain" />
